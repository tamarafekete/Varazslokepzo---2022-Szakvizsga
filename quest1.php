...
<html>
<head>
<title>Beosztási ceremónia</title>	
<meta charset="UTF-8">
...
?>
<div id="tartalom">
<h1>Beosztási ceremónia</h1>
<div class="quest" id="story1">
<img src="images/questimages/sorting_ceremony.jpg">
<p>Egy újabb tanév veszi kezdetét a Roxfort Boszorkány- és Varázslóképző Szakiskolában, mely megnyitója hagyományosan az elsőévesek beosztásával kezdődik. A legifjabb tanoncok között nincs hiány sem a remegő, sápadt gyerekarcokból, sem a mosolyra görbülő szájakból.<br><button onclick="showNext('story1', 'story2')">Tovább</button>
</p>
</div>
